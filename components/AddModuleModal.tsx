...
const AddModuleModal: React.FC<AddModuleModalProps> = ({ isOpen, onClose, onAdd }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50" onClick={onClose}>
      ...
      >
        <h2 className="text-xl font-bold text-blue-400 mb-4 flex-shrink-0">Neues Modul erstellen</h2>
        <form onSubmit={handleSubmit} className="flex-1 flex gap-6 overflow-hidden">
          <div className="flex-1 flex flex-col gap-4">
            <div>
              <label htmlFor="mod-title" className="block text-sm font-medium mb-1">
                Modul-Titel
              </label>
              <input
                id="mod-title"
            ...
            <div className="flex-1 flex flex-col">
              <label htmlFor="mod-content" className="block text-sm font-medium mb-1">
                Inhalt
              </label>
              <textarea
                id="mod-content"
